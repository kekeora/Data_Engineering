...
matrix = np.load("E:/pythonProject/lad 2/data/first_task.npy")
...
with open("E:/pythonProject/lad 2/result/first_task.json", "w", encoding="utf-8") as f:
            json.dump(matrix_props, f)

norm_matrix = matrix / matrix_props['sum']
np.save("E:/pythonProject/lad 2/result/first_task.npy", norm_matrix)
